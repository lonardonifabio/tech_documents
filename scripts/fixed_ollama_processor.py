...
class FixedOllamaDocumentProcessor:
    ...
    def extract_pdf_text(self, filepath: Path, max_pages: int = 5) -> str:
    ...
    def analyze_document_enhanced(self, text: str, filename: str) -> Dict:
        ...
        chunks = self.chunker.chunk_document(text, max_pages=5)
    ...
    def process_document(self, filepath: Path) -> Dict:
        ...
        text_content = self.extract_pdf_text(filepath, max_pages=5)
